...
function UpdateNote(props) {
    ...
    onClick={(e)=>props.getNote(e,props.elementId)}>Update</button>
          ...
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <span className="modal-title" id="exampleModalLabel">Update Note</span>
              ...
              <div className="modal-footer">
                ...
                <button type="button"
                 ...
                 data-dismiss="modal"
                 onClick={(event)=>props.updateNote(event,props.elementId)}>Update</button>
              </div>
            </div>
          </div>
        </div>
