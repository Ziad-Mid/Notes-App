...
function DeleteNote(props) {
    ...
    onClick={(e)=>props.getNote(e,props.elementId)}>Delete</button>
          ...
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <span className="modal-title" id="exampleModalLabel">Delete Note</span>
              ...
              <div className="modal-footer">
                ...
                <button type="button"
                 ...
                 data-dismiss="modal"
                 onClick={(event)=>props.deleteNote(event,props.elementId)}>Delete</button>
              </div>
            </div>
          </div>
        </div>
